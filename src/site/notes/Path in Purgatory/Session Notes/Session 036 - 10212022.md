---
{"dg-publish":true,"dg-permalink":"/path-in-purgatory/session-notes/session-36","permalink":"/path-in-purgatory/session-notes/session-36/","title":"One Tense Conversation","tags":["notes, session"]}
---
...
She opens all the presents. For Twin, there are a deck of cards (not all 52, a [[30 Resources/Magic Items/Deck of Illusions\|Deck of Illusions]]) for his chaotic and creative nature. For Fen, a smaller item, a font style pen ([[emerald pen\|emerald pen]] that casts the [[illusory spell\|illusory spell]]) that does not require ink to write and illusion magic. Ashissa looks and calls for Fen to cast [[30 Resources/Spellbook/Identify\|Identify]], though cannot seem to find her immediately. 
...
This event is not 100% a death trap, however, given the circumstances and his track record, Averill understands his temper may prove fatal, and Ashissa offers [[30 Resources/Spellbook/Calm Emotions\|Calm Emotions]] if necessary.
