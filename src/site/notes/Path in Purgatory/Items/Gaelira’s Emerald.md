---
{"dg-publish":true,"permalink":"/path-in-purgatory/items/gaelira-s-emerald/","tags":["artifact","gem","god","homebrew","item","magic"]}
---
...
<aside>
	...
	<div class="aside-data aside-item aside-item-spacing">
			...
			<div class="aside-value"><a class="internal-link" href="/path-in-purgatory/the-party/fenmarel-mithalvarin/">Fenmarel Mithalvarin</a> (Current)</div>
		</div>
	</section>
</aside>

### Dormant
This fist-sized emerald seems to be hollow inside, a sort of terrarium of wildlife flourishing within its confines. It resonates with life-giving power. The gem seems dormant, as though a greater power sleeps within. (You can only be attuned to one God-Gem at a time. Unattuning from a God-Gem resets it to a dormant state.)

While attuned to this emerald you gain the following benefits:

-   You are resistant to poison, acid, and necrotic damage.

Once per long rest, you can cast the [[mass cure wounds\|mass cure wounds]] spell at 5th level as a bonus action.