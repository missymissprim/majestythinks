---
{"dg-publish":true,"permalink":"/path-in-purgatory/items/sea-piercer/","tags":["artifact","combat","damage","homebrew","item","magic","rapier","weapon"]}
---
...
<aside>
	...
	<div class="aside-data aside-item aside-item-spacing">
			...
			<div class="aside-value">Tamer of Oceans<br>Sealer of the Signed</div>
		</div>
		<div class="aside-data aside-item aside-item-spacing">
			<div class="aside-label">Type</div>
			<div class="aside-value">Weapon (rapier)</div>
		</div>
		...
		<div class="aside-item aside-data aside-item-spacing">
			...
			<div class="aside-value">2 lbs.</div>
		</div>
	</section>
	<section class="aside-item">
	...
	<div class="aside-data aside-item aside-item-spacing">
			...
			<div class="aside-value"><a class="internal-link" href="/path-in-purgatory/the-party/twin-garden/">Twin Garden</a> (Current)</div>
		</div>
	</section>
</aside>

### Dormant
This weapon gleams with a pearlescent quality, shimmering like the sea floor. Inscribed on the pommel of this weapon are celestial runes that glow a deep blue. They read “Tamer of Oceans, Sealer of the Signed, the Sea Piercer”
...
While attuned to this weapon, the negative effects from a blessing of Winora are mitigated. You may expend a number of hit dice up to your current proficiency bonus to reduce the levels of exhaustion gained by one per hit die expended.

<p class="small">Tags: <span class="tags">Combat</span> <span class="tags">Damage</span></p>