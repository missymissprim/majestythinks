---
{"dg-publish":true,"permalink":"/path-in-purgatory/items/diadem-of-wrath/","tags":["artifact","homebrew","item","magic"]}
---
...
<aside>
	...
	<div class="aside-data aside-item aside-item-spacing">
			...
			<div class="aside-value"><a class="internal-link" href="/path-in-purgatory/the-party/ignan-regarin/">Ignan Regarin</a> (Current)</div>
		</div>
	</section>
</aside>

The Diadem of Wrath is a metal circlet with a gem at the center. It was the symbol of Felgrand’s when they took over [[Path in Purgatory/Locations/Chasmia\|Chasmia]] and used to pass judgment on those who were under scrutiny of those in the [[Blazing Chapel\|Blazing Chapel]] to judge those and burn them alive to their very soul.