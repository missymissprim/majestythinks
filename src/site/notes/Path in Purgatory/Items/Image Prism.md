---
{"dg-publish":true,"permalink":"/path-in-purgatory/items/image-prism/","tags":["deception","homebrew","item","magic"]}
---
...
<aside>
	...
	<div class="aside-data aside-item aside-item-spacing">
		...
		<div class="aside-item aside-data aside-item-spacing">
			...
			<div class="aside-value">Rare</div>
		</div>
		<div class="aside-data aside-item aside-item-spacing">
	...
	<div class="aside-data aside-item aside-item-spacing">
			...
			<div class="aside-value"><a class="internal-link" href="/path-in-purgatory/the-party/twin-garden/">Twin Garden</a></div>
		</div>
	</section>
</aside>

This small prism seems to shimmer a different color at each facet, showing a reflection of the person holding it no matter how it is positioned by the light.

This gemstone can be used to cast the [[mirror image\|mirror image]] spell once per day as a bonus action. (Recharges at dawn.)

<p class="small">Tags: <span class="tags">Deception</span></p>